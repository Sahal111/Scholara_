...
// primary   = #1e1b4b  (deep dark green)
// secondary = #7c3aed  (medium green)  ← used for active nav, badges, buttons
...
function ModalKelas({ open, onClose, editData, queryClient }) {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries(["wakasek-kelas"]);
      onClose();
    },
    onError: (err) => {
  ...
  const inputCls =
    "w-full px-4 py-2.5 bg-[#f2f4f3] border border-[#bfc9c4]/40 rounded-xl text-sm text-[#191c1c] focus:ring-2 focus:ring-[#7c3aed]/30 focus:border-[#7c3aed] outline-none transition-all placeholder:text-[#707975]";
  const labelCls =
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-[#bfc9c4]/30 bg-[#f2f4f3]">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-[#7c3aed]/10 flex items-center justify-center border border-[#7c3aed]/20">
              <span className="material-symbols-outlined text-[22px] text-[#7c3aed]">
                {isEdit ? "edit_note" : "add_circle"}
              </span>
            </div>
            <div>
              <h3
                className="text-base font-bold text-[#1e1b4b]"
          ...
          {isEdit && (
            <div className="flex items-center justify-between p-3.5 bg-[#f2f4f3] rounded-xl border border-[#bfc9c4]/30">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${form.is_active ? "bg-[#7c3aed]" : "bg-[#e1e3e2]"}`}
              >
                <span
...
// ── Main Page ─────────────────────────────────────────────────────────────────
export default function MasterKelasWakasek() {
  ...
  const { data: tahunAjaranList } = useQuery({
    queryKey: ["wakasek-tahun-ajaran-dropdown"],
    queryFn: () =>
  ...
  const selectCls =
    "w-full bg-[#f2f4f3]/50 border border-[#bfc9c4]/20 rounded-2xl py-3.5 pl-4 pr-10 text-[#191c1c] font-bold text-xs uppercase tracking-wider focus:ring-2 focus:ring-[#7c3aed]/20 focus:border-[#7c3aed] appearance-none cursor-pointer transition-all outline-none";
    ...
    <div className="w-full space-y-10 pb-12">
        ...
        <div className="relative flex-1">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to right, rgba(124,58,237,0.2), transparent)",
              }}
            ></div>
          </div>
          ...
          <button
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow =
                "0 16px 24px rgba(124,58,237,0.3)";
            }}
            onMouseLeave={(e) => {
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        ...
        >
          <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity pointer-events-none">
            <span
              className="material-symbols-outlined text-[#1e1b4b]"
              style={{ fontSize: "80px" }}
            >
              meeting_room
            </span>
        ...
        >
          <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity pointer-events-none">
            <span
              className="material-symbols-outlined"
              style={{ fontSize: "80px", color: "#7c3aed" }}
            >
              person_check
            </span>
          </div>
          <div className="relative z-10">
            ...
            >
              <div
                ...
                style={{ width: `${waliPct}%`, background: "#7c3aed" }}
              />
            </div>
          </div>
        </div>
        ...
        >
          <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity pointer-events-none">
            <span
              className="material-symbols-outlined"
              style={{ fontSize: "80px", color: "#1e1b4b" }}
            >
              groups
            </span>
          </div>
      ...
      <div
        ...
        style={{
          ...
          boxShadow: "0 8px 30px rgba(30,27,75,0.04)",
        }}
      >
        {/* Toolbar */}
        <div
                ...
                kelasList.map((k) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Kode — font-mono, color secondary=#7c3aed */}
                      <td
