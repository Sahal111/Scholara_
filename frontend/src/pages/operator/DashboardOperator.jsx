...
export default function DashboardOperator() {
  ...
  return (
    <>
      <div className="flex-1 px-3 pt-2 pb-6 sm:px-4 sm:pt-2 space-y-4 max-w-[1600px] mx-auto w-full">
        {/* ── Greeting Header ─────────────────────────────────────── */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
          ...
          <div className="bg-white rounded-2xl p-4 border border-slate-200/70 shadow-sm lg:col-span-7 flex flex-col gap-3">
              ...
              <table className="w-full text-left text-[11px] border-collapse">
                <thead>
                  <tr className="border-b border-slate-200/80 bg-slate-50/80 text-[10px] text-slate-400 uppercase tracking-wider font-semibold">
                    ...
                    <th className="py-1.5 pr-2 text-right rounded-r-lg">
                      Aksi
                    </th>
                  </tr>
                </thead>
            ...
            <div className="pt-2 border-t border-slate-100 flex items-center justify-between text-[10px] text-slate-500">
              <span>
                Menampilkan{" "}
                <b className="text-slate-800">{REGISTRASI.length}</b> data
                terbaru
              </span>
              <Link
                to="/operator/approval-ortu"
            ...
            <div className="flex flex-col gap-2.5">
              {[
                ...
                },
                {
                  ...
                  badge: "Ruang Rapat",
                  badgeColor:
                    "bg-purple-100 text-purple-900 ring-purple-600/20",
