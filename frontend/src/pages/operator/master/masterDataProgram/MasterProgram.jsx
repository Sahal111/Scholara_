...
// ── Modal Tambah / Edit ───────────────────────────────────────────────────────
function ModalProgram({ open, onClose, editData, defaultJenis }) {
    ...
    setForm(
      editData
        ? {
            ...
            nama: editData.nama ?? "",
            kode: editData.kode ?? "",
            jenis: editData.jenis ?? "konsentrasi_keahlian",
        ...
        <div className="overflow-y-auto flex-1 px-6 py-5 space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              >
                {JENIS_LIST.filter((j) => j.value !== "semua").map((j) => (
    ...
    <>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 relative gap-8">
        ...
        <div className="flex flex-wrap items-center gap-4 relative z-10">
          {/* Tambah Konsentrasi */}
          <button
            onClick={() => handleTambah("konsentrasi_keahlian")}
          ...
          {/* Tambah Program */}
          <button
            onClick={() => handleTambah("program_keahlian")}
        ...
        {!isLoading && programs.length > 0 && (
          ...
          >
            <p className="text-sm text-[#3f4945]">
              ...
              sampai{" "}
              <span className="font-medium text-[#00342b]">{meta.to ?? 0}</span>{" "}
              dari{" "}
              <span className="font-medium text-[#00342b]">
                {meta.total ?? 0}
              </span>{" "}
