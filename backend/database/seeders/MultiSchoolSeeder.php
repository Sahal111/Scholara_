...
class MultiSchoolSeeder extends Seeder
{
    ...
    private function rolePermissionMatrix(): array
    {
        ...
        return [
            ...
            'wakasek' => ['master_data.guru.view', 'master_data.guru.export', 'master_data.guru.verify', 'master_data.siswa.view', 'master_data.siswa.export', 'master_data.kelas.view', 'master_data.kelas.manage', 'master_data.mapel.view', 'master_data.mapel.manage', 'master_data.tahun_ajaran.view', 'master_data.tahun_ajaran.manage', 'master_data.program.view', 'master_data.program.manage', 'master_data.kurikulum.view', 'master_data.kurikulum.manage', 'master_data.orang_tua.view', 'absensi.view_all', 'absensi.rekap', 'dms.view_all', 'dms.approve', 'dms.download', 'dms.bulk_download', 'pengumuman.view', 'pengumuman.create', 'pengumuman.update', 'pengumuman.delete', 'laporan.guru.view', 'laporan.siswa.view', 'laporan.absensi.view', 'laporan.export', 'akademik.jadwal.view', 'akademik.jadwal.manage', 'akademik.kalender.manage', 'akademik.nilai.view', 'akademik.nilai.view_all', 'akademik.rapor.view', 'akademik.rapor.manage', 'pengaturan.view'],
