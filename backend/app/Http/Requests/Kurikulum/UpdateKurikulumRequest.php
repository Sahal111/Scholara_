...
class UpdateKurikulumRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $currentId = \App\Models\Kurikulum::where('ulid', $ulid)->value('id');
        ...
        return [
            ...
            'kode' => [
                ...
                'max:30',
                'alpha_dash',
                Rule::unique('kurikulums', 'kode')
                    ->where('school_id', $schoolId)
                    ->ignore($currentId),
            ],
            'tahun_berlaku' => ['sometimes', 'integer', 'min:1900', 'max:2100'],
            'tahun_berakhir' => ['nullable', 'integer', 'min:1900', 'max:2100', 'gte:tahun_berlaku'],
            'jenis' => ['sometimes', Rule::in(['nasional', 'internasional', 'khusus', 'custom'])],
